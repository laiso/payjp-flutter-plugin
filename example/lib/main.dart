...
import 'screens/resource_id_3d_secure_screen.dart';
        ...
        builder: (context) => ListView(
              ...
              children: <Widget>[
                ...
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(context);
                    _onStart3DSecureCardForm(formType: CardFormType.cardDisplay);
                  },
                ),
              ],
            ));
...
You can send token(${token.id}) to your own server to make Customer etc.
  ...
  void _navigateToResourceId3DSecureScreen() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => ResourceId3DSecureScreen()),
    );
  }
                  ...
                  children: <Widget>[
                    ...
                    material.Card(
                      child: ListTile(
                        ...
                        subtitle: Text('Tap here to start 3D secure with resource ID.'),
                        onTap: () {
                          _navigateToResourceId3DSecureScreen();
                        },
                      ),
                    ),
                  ],
